 ...
 * @type {number}
 */
const INITIAL_POOL_SIZE_DEFAULT = 10;
let initial_remaning_count = INITIAL_POOL_SIZE_DEFAULT;
/**
 * 超过频率限制
 * @param opts
 */
 ...
 * @param {number} num 
 */
export function setInitialPoolSize(num = INITIAL_POOL_SIZE_DEFAULT) {
    initial_remaning_count = num;
}
